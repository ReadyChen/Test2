...
-(IBAction)deleteAction:(UIBarButtonItem *)sender{
    ...
    switch(btn.tag)
    {
        case 1:
        {
            ...
            bAddLeavedDistFlag = !bAddLeavedDistFlag;
            DS.bAddLeavedFlag = bAddLeavedDistFlag;
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    bAddLeavedDistFlag = DS.bAddLeavedFlag;
